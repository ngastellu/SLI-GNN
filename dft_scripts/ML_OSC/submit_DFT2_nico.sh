...
echo "Running on directory C/C$ndir (<-- this script a command line arg; there should be a number here...)"

XYZ_DIR="/scratch/ngaste/ML_OSC/C/C$ndir"  
OUTPUT_DIR="/scratch/ngaste/ML_DFT/C/C$ndir"  
